...
class ExpensesController extends AbstractController
{
    ...
    public function index(Request $request, ExpensesRepository $expensesRepository): Response
    {
        ...
        // Utiliser la méthode findByFilters pour récupérer les dépenses en fonction des filtres
        $expenses = $expensesRepository->findByFilters($selectedMonth, $selectedYear);
    ...
    #[Route('/list', name: 'app_list_month', methods: ['GET'])]
    public function listMonth(ExpensesRepository $expensesRepository): Response
    {
        return $this->render('expenses/list_month.html.twig', [
            'expenses' => $expensesRepository->findAll(),
        ]);
    }
