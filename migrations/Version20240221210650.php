 ...
 */
final class Version20240221210650 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT NOT NULL, category_id INT NOT NULL, company_id INT DEFAULT NULL, quote_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, reference VARCHAR(70) DEFAULT NULL, description TEXT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, search_vector TSVECTOR DEFAULT \'\', PRIMARY KEY(id))');
